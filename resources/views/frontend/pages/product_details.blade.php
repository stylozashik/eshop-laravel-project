                            ...
                            @foreach ($category as $item)
                                @if ($item->category_status == 1)
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="/category/{{$item->category_id}}/products">{{$item->category_name}}</a></h4>
                                    </div>
                                    </div>
                                @endif
					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{asset("storage/$find_product->product_image")}}" alt="" />
								<h3>ZOOM</h3>
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<h2>{{ $find_product->product_title }}</h2>
								<p>{{ $category_info->first()->category_name }}</p>
								<span>
								...
								<form action="/cart" method="post">
									...
									<label>Quantity:</label>
											<input type="text" step="1" name="product_quantity" value="{{ $find_product->product_quantity }}"/>
											<input type="hidden" name="product_id" value="{{ $find_product->product_id }}"/>
