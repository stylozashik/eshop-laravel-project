					...
					<div class="row">
                        ...
                        <h3>We are almost done !</h3>
							<div class="total_area">
								...
								<ul>
									<li>Sub Total : <span>৳ {{ $cart_subtotal }}</span></li>
									<li>Vat & Tax (5%) :<span>৳ {{ $cal_tax }}</span></li>
									<li>Shipping :<span>Free</span></li>
									<strong><li>Total Cost <span>৳ {{ $cart_total }}</span></li></strong>
								</ul>
							</div>
						</div>
						<div class="col-sm-6">
                            <div class="jumbotron">
                                <form action="{{url('/confirm-order')}}" method="post">
									@csrf
									<label><input type="radio" name="payment_method" value="1" checked> Cash On Delivery</label><br>
									<label><input type="radio" name="payment_method" value="2" > Bank Transfer</label><br>
									<label><input type="radio" name="payment_method" value="3" > Paypal</label><br>
